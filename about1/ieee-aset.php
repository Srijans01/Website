        ...
        <section class="paddings">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7">
                         <br><p><a href="#" target="_blank"><b>IEEE ASET</b></a> is a Student Branch of IEEE was founded in 2003 by Piyush Arya. It endeavors to realize the dreams of the budding
						 engineers. It mainly aims to spread the knowledge to one and all in all the upcoming fields of robotics, telecommunication,
						 electronics, computers etc. by organizing workshops, events, quizzes and publishing newsletters, Annual Magazine and DVD. Other
						 than that, it gives opportunity to members to take up various projects and organize various Interactive meets with members as 
						 well.</p><br>
                         <p>Being in IEEE makes you proud and confident. IEEE ASET serves as the best forum to gain knowledge and publicize your ideas,
						 thus widening your own imagination. IEEE ASET works hard to involve all its members and provides the best to furnish the best!!
						 Here, working is done on the latest gizmos and technologies. IEEE ASET also allows you to experiment.  All read seems very serious 
						 and boring but when it comes to practicing with IEEE ASET, it’s entertaining and enthusiastic. IEEE ASET involves a lot of teamwork 
						 and sportsman spirit.</p>						
					</div>
				 ...
				 <div class="row">
				<div class="col-md-12">
					<p>It consists of a board of chair-person, vice chair-person, treasurer, secretary, event managing team, technical team, publications 
					team and web designing team. Apart from the board members, members also actively take part and have the right to voice their opinion. 
					So come to fulfill your dreams because being an IEEEian is no less than a dream!!</p>
					<hr>
				</div>
				</div>
            </div>
