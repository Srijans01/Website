        ...
        <section class="paddings">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7">
                         <br><p>The <a href="http://www.ieee.org/index.html" target="_blank" style="text-decoration:none;"><b>Institute of Electrical and
						 Electronic Engineers (IEEE)</b></a> is a non profitable organization dedicated towards the advancement of technological innovation
						 related to electricity. It was formed in 1963 by the merger of the Institute of Radio Engineers (IRE, founded 1912) and the American 
						 Institute of Electrical Engineers (AIEE, founded 1884).</p><br>
                         <p>It has more than 400,000 members in more than 160 countries. IEEE's Constitution defines the purposes of the organization as
						 "scientific and educational, directed toward the advancement of the theory and practice of Electrical, Electronics, Communications 
    				  and Computer Engineering, as well as Computer Science, the allied branches of engineering and the related arts and sciences."</p>
				 ...
				 <div class="row">
				<div class="col-md-12">
					<p>Lemme catechize: this means that IEEE funds a majority of technical patents and produces 30% of the world's literature in the
					electrical and electronics engineering and computer science fields, publishing well over 100 peer-reviewed journals. The content 
					in these journals as well as the content from several hundred annual conferences are available in the IEEE's online digital library. 
					It is also a leading developer of industrial standards (having developed over 900 active industry standards) in a broad range of 
					disciplines, including electric power, healthcare, information technology, telecommunications, aerospace etc.</p> 
					<p>IEEE develops and participates in educational activities such as accreditation of electrical engineering programs in institutes of
					higher learning. In addition it also sponsors a website designed to help young people understand better what engineering means. Students,
					parents, and teachers can explore the site to prepare for an engineering career, ask experts engineering-related questions, play
					interactive games, and much more. IEEE is one of the leading standards-making organizations in the world. IEEE performs its standards
					making and maintaining functions through the <a href="http://standards.ieee.org/" target="_blank" style="text-decoration:none;"><b>IEEE 
					Standards Association</b></a>. In fact IEEE standards affect a wide range of industries including biomedical and healthcare,
					nanotechnology etc. As we reach the cessation of the article, it can be said that this organization is a reservoir of information, it
					is up to us to use this reservoir efficiently and judiciously in order to create a win win situations for all.</p>
					<hr>
				</div>
				</div>
            </div>
