        ...
        <section class="paddings">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7">
                         <br><p><a href="#" target="_blank"><b>Sanjeev Kumar</b></a> An Inspirer. An Ideal. An Engager. These three characteristics are just a short sample of the many that he demonstrates to his students each day. He has been our pillar of support. He is the binding force that makes IEEE ASET what it is. The most helpful and down to earth person. He cares for us like his own and always deciphers if  we go wrong. Our troubleshooter, he guides us out of the tunnels of darkness and he is the light at the end of it. The person who nourished us to become polished professionals from naive students.</p><br>
                         <p>His being in IEEE makes us proud and confident. He serves as the best forum to gain knowledge and select our ideas,
						 thus widening our own imagination. He works hard to involve all the members and provides the best to furnish the best!!
						 He also allows us to experiment.He involves a lot of teamwork 
                        ...
                        <div id="carousel-example-generic" class="carousel slide bs-docs-carousel-example">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img src="../img/works/1b.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="../img/works/2b.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="../img/works/3b.jpg" alt="">
                                </div>
								                                <div class="item">
                                    <img src="../img/works/4b.jpg" alt="">
                                </div>

								                                <div class="item">
                                    <img src="../img/works/5b.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="../img/works/6b.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="../img/works/7b.jpg" alt="">
                                </div>
                                <div class="item">
                                    <img src="../img/works/8b.jpg" alt="">
                                </div>
