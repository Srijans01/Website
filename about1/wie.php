        ...
        <section class="paddings">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7">
                         <br><p>From ancient times to modern world women has undergone various changes. She has been portrayed as a slave who is only made for
						 doing household chores and has been discriminated as a girl child, harassed for bribe and many more. But with the advancement of 
						 technology and education they had got equal rights and opportunities. In today's world women has the right to talk, act, fight and
						 has a safe and secured life. For the women who has remarkably high self-esteem, surprising overall job satisfaction, and very good 
						 skills for coping with problems.<a href="#" style="text-decoration:none;"><b>IEEE Women in engineering (WIE)</b></a>is facilitating programs 
						 and activities for the welfare of women society.<br><br>
                         IEEE women in Engineering (WIE) is the largest International professional organization dedicated to promoting women engineers and
						 scientists and inspiring girls around the world to follow their academic interests to a career in engineering. The mission of 
						 IEEE WIE is to facilitate the global recruitment and retention of women in technical disciplines. IEEE WIE envisions a vibrant 
						 community of IEEE women and men collectively using their diverse talents to innovate for the benefit of humanity.</p>
				...
				<div class="col-md-12">
					<p>IEEE WIE strives to : 
						...
						<br><br>IEEE Women in engineering (WIE) provides members with the opportunity to network at a local level through WIE affinity groups.
						Currently, there are over 355 IEEE WIE affinity groups worldwide that organize and host diverse activities including guest speakers,
						workshops and seminars. These groups are given awards annually to one WIE affinity group and one WIE student affinity organizing
						activities, followed by different programs. In addition to encouraging students to pursue engineering, WIE aims to convey the message 
						that maths, and science are fun, engineering has career options that benefit humanity, and is gender neutral. Therefore current ”STAR”
						program will include the following reportable pre-university outreach: 
						<br><i class="fa fa-plus-square"></i> Classroom Activities
						<br><i class="fa fa-plus-square"></i> Humanitarian projects involving the pre-university community
						<br><i class="fa fa-plus-square"></i> Competitions
						<br><i class="fa fa-plus-square"></i> Hands on activities
						<br><i class="fa fa-plus-square"></i> Training of pre-university teachers
						<br><i class="fa fa-plus-square"></i> Mentoring
						<br><i class="fa fa-plus-square"></i> Public awareness activities 
						<br><i class="fa fa-plus-square"></i> Field trips
						<br><i class="fa fa-plus-square"></i> Technical support networking 
						<br><br>
						Moreover it provides membership categories that recognizes outstanding individuals through the special membership categories of IEEE
						Fellow and IEEE Honorary Member. Additionally, Senior Membership is an opportunity for IEEE members to be recognized for their 
						achievements. Hence this can change the current status of every women and help each and every one to fulfill thrie needs and their 
						dreams come true.</p>
					<hr>
				</div>
				</div>
