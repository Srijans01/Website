        ...
        <section class="paddings">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-7">
                         <br><p>The <a href="#" target="_blank" style="text-decoration:none;"><b>IEEE Computer Society </b></a>
						 is the computing professional's single, unmatched source for technology information, inspiration and collaboration. By making the
						 most up-to-date and advanced information in the computing world easily accessible, we are the source that computing professionals 
						 trust to provide high quality, state-of-the-art information on an on-demand basis. </p>	
						<p><b>INFORMATION</b><br>Our wide range of technical conferences, publications, and digital library provide forums for top minds to 
						 come together to develop, validate, and disseminate the highest quality information. We offer everyone from students to advanced
						 practitioners education, professional development, certifications, and standards for professional practices.</p>
					</div>
				 ...
				 <div class="row">
				<div class="col-md-12">
					<p><b>TRAINNING</b><br>Our unique training webinars, professional training, and the TechLeader Training Partner Program give organizations an opportunity
					to increase the technical knowledge and expertise of their staffs. These rich, self-selected, and self-paced programs help companies
					improve the quality of technical training and attract top talent while reducing costs.</p> 
					<p><b>INSPIRATION</b><br>What's more, because we offer our members a collaborative environment for creativity and productivity as well as the resources to 
					advance their knowledge and professional training, we're the home of the world's great technology leaders and innovators.</p>
					<p><b>COMMUNITY</b><br>The IEEE Computer Society is the world's leading computing membership organization and the trusted information and 
					career-development source for a global workforce of technology leaders including: professors, researchers, software engineers, IT 
					professionals, employers, and students -our future technology leaders. Members have endless opportunities to network with the world's 
					foremost technology professionals, to lead the community by volunteering and mentoring, and to both gain exposure and contribute to the
					field as authors and reviewers.</p>
					<hr>
				</div>
				</div>
            </div>
